...
const BookDetailComponent = ({ book }) => {
  return (
    <main className="p-5">
      ...
      <div className="mb-5">
        <ul className="flex text-[#0B3954] font-semibold items-center space-x-4">
          ...
          <li className="flex items-center">
            ...
            <Link href="/book-categories">Categories</Link>
            <svg
              className="h-4 m-4 w-4"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 384 512"
      ...
      <div className="bg-white rounded-2xl max-w-screen">
        <div className="p-6 rounded-lg shadow-md w-full">
          {/* Image on Right, Text on Left (Mobile: Stacks Image on Top) */}
          <div className="flex flex-col p-4 rounded-lg gap-6 items-center md:flex-row-reverse md:items-start">
            {/* Book Image */}
            ...
            {/* Book Details (Text Below Image on Mobile) */}
            <div className="flex-1 text-center md:text-left space-y-4">
              ...
              <p className="text-[#0B3954] text-md font-medium">
                Created at{" "}
                {book.created_at
              ...
              <p className="text-[#0B3954] text-justify">{book.description}</p>
            </div>
          </div>
        </div>
      </div>
